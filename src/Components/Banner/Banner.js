...
const Banner = () => {
    return (
        <div className='md:flex justify-between gap-10 items-center md:px-20 p-5 bg-nav'>
            ...
            <div className='md:w-1/2'>
                ...
                <div>
                    <button className='bg-[#E02156] px-10 mt-5 py-3 text-white font-bold uppercase rounded-sm '>Hire Us</button>
                </div>
            </div>
