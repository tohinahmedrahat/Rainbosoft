...
const Pricing = () => {
    return (
        <div>
            ...
            <div className="flex flex-col md:flex-row md:transform md:scale-75 lg:scale-100 justify-center gap-10">
                <div className="rounded-lg  text-center p-5 mx-auto md:mx-0 my-2 md:my-6 bg-[#4CE8F6] font-medium z-10 shadow-lg">
                ...
                <div className="border-transparent rounded-lg text-center p-5 mx-auto md:mx-0 my-2 pricing bg-[#ccc8c880] text-white font-medium z-10 shadow-lg">
                ...
                <div className="rounded-lg   text-center p-5 mx-auto md:mx-0 my-2 md:my-6 bg-[#D4A3D2] font-medium z-10 shadow-lg">
