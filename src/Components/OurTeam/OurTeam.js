...
import './OurTeam.css';
import tuhin from '../../assets/img/tohin.webp'
...
<div class="mb-16">
            <dh-component>
                <div class="container flex justify-center mx-auto pt-16">
                    <div>
                        <p class=" text-lg text-center font-normal pb-3">BUILDING TEAM</p>
                ...
                <div class="w-full card-team px-10 pt-10">
                    <div class="container mx-auto">
                        <div role="list" aria-label="Behind the scenes People " class="lg:flex md:flex sm:flex items-center xl:justify-between flex-wrap md:justify-around sm:justify-around lg:justify-around">
                            <div role="listitem" class=" relative mt-16 mb-32 sm:mb-24 xl:max-w-sm">
                                <div class="rounded overflow-hidden shadow-md bg-[#dbe2de2c]">
                                    <div class="absolute -mt-20 w-full flex justify-center">
                                        <div class="h-32 w-32">
                                       
                                            <img src={tuhin} alt="Display Picture of Andres Berlin" role="img" class="object-cover h-full w-full" />
                                        </div>
                                    </div>
