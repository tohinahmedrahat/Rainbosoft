    ...
    <div className="grid lg:grid-cols-3 md:w-[90%] w-[100%] md:mx-auto pb-5 md:gap-7 container">
      <div className="card-cover md:m-[50px] md:w-[350px] w-[300px]">
        ...
        <div className="linkShareSection">
          <a href="https://www.facebook.com/Bleaklife/">
            <FacebookIcon fontSize="large"></FacebookIcon>
          </a>
          <a href="https://www.linkedin.com/in/tohim-ahmed/">
            <LinkedInIcon fontSize="large"></LinkedInIcon>
          </a>
          <a href="https://twitter.com/tohinahmed15">
        ...
        <div className="intro">
          ...
          <div className="customIntro">
            <h2 className="font-semibold md:text-xl m-2">
              Programmer & Support Engineer
            </h2>
            <h3 className="text-lg m-2">
              <EmailIcon className="text-green-400"></EmailIcon>{" "}
              tohin@rainbosoft.com
            </h3>
          </div>
        </div>
      </div>
